...
COMMANDS: tuple[PraxisCommand, ...] = (
    ...
    PraxisCommand("codegraph init"),
    PraxisCommand("codegraph status"),
    PraxisCommand("codegraph sync"),
    PraxisCommand("codegraph explore <query>"),
    PraxisCommand("codegraph query <symbol>"),
    PraxisCommand("codegraph impact <symbol>"),
    ...
    PraxisCommand("system codegraph init"),
    PraxisCommand("system codegraph status"),
    PraxisCommand("system codegraph sync"),
    PraxisCommand("system codegraph explore <query>"),
    PraxisCommand("system codegraph query <symbol>"),
    PraxisCommand("system codegraph impact <symbol>"),
