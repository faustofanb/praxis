...
def command_argv(command: list[str]) -> list[str]:
    """Resolve workflow Git commands to macOS system Git.

    Codex ships a bundled Git before /usr/bin in PATH, but it does not inherit
    the system osxkeychain credential helper used by CodeUp HTTPS remotes.
    """
