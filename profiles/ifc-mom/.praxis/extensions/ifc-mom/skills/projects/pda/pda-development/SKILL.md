...
- 开发前必须读取 `.praxis/extensions/ifc-mom/rules/projects/pda/README.md`，再按改动类型展开读取对应细则；不得只依赖本 skill 的摘要。
- 页面放在 `src/pages/`
...
- 页面/路由：`.praxis/extensions/ifc-mom/rules/projects/pda/02-项目结构规范.md`、`03-路由规范.md`
- API/DTO：`.praxis/extensions/ifc-mom/rules/projects/pda/05-API开发规范.md`
- Store/跨页状态：`.praxis/extensions/ifc-mom/rules/projects/pda/06-状态管理规范.md`
- 样式/主题：`.praxis/extensions/ifc-mom/rules/projects/pda/07-样式规范.md`
- 扫码/弱网/长列表性能：`.praxis/extensions/ifc-mom/rules/projects/pda/08-移动端性能规范.md`
- 验证与交付：`.praxis/extensions/ifc-mom/rules/projects/pda/09-开发工作流规范.md`
